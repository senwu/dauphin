...
from dauphin.image.models.shake_drop import ShakeDrop
...
class PyramidNet(nn.Module):
    def __init__(
        self, dataset, depth, alpha, num_classes, bottleneck=True, has_fc=True
    ):
    ...
    def __repr__(self):
        return f"{type(self).__name__} {self.depth} {self.alpha}"
